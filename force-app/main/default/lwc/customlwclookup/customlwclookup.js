...
export default class Customlwclookup extends LightningElement {
    ...
    /* parentidfield - the apiname of lookup/matser-detail in the child object this field is 
    useful to indentify which parent record has been select
    if there are multiple lookup for a single child record */
    @api objectName = 'Event__c';
    @api fieldName  = 'Name';
    @api iconname   = 'standard:record';
    @api label      = 'Event Organizer';
    @api parentidfield = 'Organizer__c';
